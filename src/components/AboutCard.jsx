  ...
  return (
    <>
      <div className="w-full px-4 mb-10 lg:w-1/2">
        <div className="flex flex-wrap rounded-2xl -z-100 hover:scale-105 transition-transform duration-300">
          <div className="w-full self-center px-4 lg:w-1/2">
            <h1 className="text-base font-semibold text-primary md:text-xl">
              <span className="block font-bold text-dark text-2xl mt-1 lg:text-[25px]">
                {name}
              </span>
            </h1>
            <h2 className="font-medium text-secondary text-lg mt-1 mb-5 lg:text-2xl">
              {jobDesk}
            </h2>
            <div className="flex items-center">
              <a
                href={whatsappLink}
                target="_blank"
                className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-secondary hover:border-sailmed hover:bg-sailmed hover:text-white"
              >
                <svg
          ...
          <div className="w-full self-end px-4 lg:w-1/2">
            <div className="relative mt-10 lg:mt-9 lg:right-0">
              ...
              />
              <span className="absolute bottom-1 top-[1.5px] -z-10 left-1/2 -translate-x-1/2 md:scale-125">
                <svg
                  widht="400"
                  height="320"
                  viewBox="0 0 200 200"
